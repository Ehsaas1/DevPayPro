...
def show_home_page():
    ...
    ui.badges(badge_list=[("Machine Learning", "default"), ("Major Project", "secondary"), ("StreamLit", "default"), ("Python", "destructive"), ("Developers", "destructive")], class_name="flex gap-2", key="badges1")
